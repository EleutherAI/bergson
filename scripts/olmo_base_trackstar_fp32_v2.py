...
Uses fp32, no FSDP, auto_batch_size, GPU memory logging, and times each step.
"""
...
class ExperimentConfig:
    ...
    # Trackstar scoring
    run_path: str = "runs/olmo3_7b_base_trackstar_fp32_v2"
...
def run_trackstar(exp_cfg: ExperimentConfig):
    ...
    print("=" * 60)
    print("Trackstar scoring with base model (fp32, no FSDP, auto_batch_size)")
    print("=" * 60)
