...
| BM25 + Qwen3-Embedding-8B hybrid (semantic weight 0.25) | 0.063 | [0.050, 0.077] | 0.208 | [0.172, 0.242] | 0.211 | -0.137 | 0.503 | 26/50 |
| BM25 | 0.062 | [0.048, 0.076] | 0.220 | [0.185, 0.252] | 0.253 | -0.168 | 0.486 | 28/50 |
| BM25 + Qwen3-Embedding-8B hybrid (semantic weight 0.5) | 0.061 | [0.048, 0.075] | 0.187 | [0.150, 0.222] | 0.182 | -0.106 | 0.511 | 24/50 |
| BM25 + Qwen3-Embedding-8B hybrid (semantic weight 0.75) | 0.056 | [0.044, 0.069] | 0.160 | [0.122, 0.196] | 0.162 | -0.110 | 0.511 | 20/50 |
...
bergson examples/compare_wikitext/trak.yaml                # scores the eight subset models and averages them
bergson examples/compare_wikitext/gradient_cosine.yaml # full and projected gradients
bergson examples/compare_wikitext/gradient_dot.yaml    # unnormalized gradient dot products
...
for a in 0.25 0.5 0.75; do   # writes baselines/hybrid_a{25,50,75}_scores/scores
  python -m examples.gradient_free_baselines.hybrid_baseline --bank runs/compare_wikitext/random --bm25 runs/compare_wikitext/baselines/bm25_scores/scores --qwen3 runs/compare_wikitext/baselines/qwen3_scores/scores --alpha $a --query_split "test[0:50]" --out runs/compare_wikitext/baselines
done
for f in magic magic_seed43 ekfac kfac kfac_p64 shampoo trak_ens gradient_dot trackstar trackstar_adam source gradient_cosine bm25 semantic qwen3 hybrid_a25 hybrid_a50 hybrid_a75 activation; do
...
for b in bm25 semantic qwen3 hybrid_a25 hybrid_a50 hybrid_a75 activation; do python examples/compare_wikitext/lds_from_bank.py --sign loss --scores runs/compare_wikitext/baselines/${b}_scores/scores --bank runs/compare_wikitext/random --out runs/compare_wikitext/lds_$b.json; done
