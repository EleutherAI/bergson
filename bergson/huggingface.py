...
class GradientCollectorCallback(TrainerCallback):
    ...
    def __init__(
        ...
        Args:
            ...
            track_moe_experts: Track fused-parameter MoE experts. Off by
                default: enabling it replaces the experts' forward for the whole
                training run, which costs throughput.
